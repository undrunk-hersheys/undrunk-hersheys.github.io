...
### Applying Theme
You may choose any theme in [jekyllthemepage](http://jekyllthemes.org/). or https://github.com/topics/jekyll-theme. Or just google it whatever you like. For my undrunk-hersheys github blog, I chose the no-style-please. https://github.com/riggraz/no-style-please. Every theme is little different but overall they are alike. Choose the right theme for you.  
